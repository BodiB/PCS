...
rail_list = [
    ...
    ("Haarlem", "Haarlem Spaarnwoude", 2.6, 100),
    ...
    ("Zaandam", "Zaandam Kogerveld", 2.5, 100),
    ("Zaandam Kogerveld", "Purmerend Weidevenne", 9.4, 100),
    ("Purmerend Weidevenne", "Purmerend", 1.6, 100),
